...
syn match phpMethod /\h\w*/ contained contains=@Spell
...
syn match phpClass /\h\w*/ contained contains=@Spell

" Class extends
syn keyword phpKeyword extends contained
      \ nextgroup=phpClassExtends skipwhite skipempty
syn match phpClassExtends /\(\\\|\h\w*\)*\h\w*/ contained contains=@Spell
...
syn match phpFunction /\h\w*/ contained contains=@Spell
